...
const testimonials = [
  ...
  {
    name: 'J.',
    quote: "I spent years in talk therapy circling the same stories. Phil's specialized approach helped me release what words never could. I finally feel safe in my own skin.",
    weeks: '8 weeks',
  },
  {
    name: 'Anonymous',
